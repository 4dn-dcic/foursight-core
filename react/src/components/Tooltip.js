...
const Tooltip = ({ id, type = "dark", position = "bottom", text = "Your tooltip here.", content=null, color = null, background = null, bold = false, italic = false, icon = false, float = false, style = null, children}) => {
    ...
    return <ReactTooltip anchorId={id}
                         ...
                         variant={type}
                         float={float}
                         style={{ ...style, borderRadius:"10px 0 10px 0", opacity:"1.0", zIndex:1000, fontWeight:bold ? "bold" : "normal" }}></ReactTooltip>
}
