...
const Tooltip = ({ id, type = "dark", position = "bottom", text = "Your tooltip here.", shape = "default", color = null, background = null, bold = false, italic = false, offset = 0, float = false, style = null, children}) => {
