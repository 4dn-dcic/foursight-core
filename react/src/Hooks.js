...
export const useSelectedComponents = (componentDefinitions) => {
    ...
    return useState({
        ...
        toggle: (type, name = null, keyedState = null) => {
            ...
            if (selectedComponentIndex >= 0) {
                ...
                const component = componentDefinitions.instantiate(type, name, keyedState);
                if (component) {
