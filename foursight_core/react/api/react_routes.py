...
#   def obsolete_reactapi_route_cognito_callback() -> Response:  # noqa: implicit @staticmethod via @route
#       """
#       Note that this in an UNPROTECTED route.
#       """
#       return app.core.obsolete_reactapi_cognito_callback(app.current_request.to_dict())
